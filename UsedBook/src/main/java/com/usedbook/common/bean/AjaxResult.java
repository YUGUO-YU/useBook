package com.usedbook.common.bean;
...
public class AjaxResult<T> {
     ...
     * @date 2020年2月17日
     */
    public static <T> AjaxResult<T> success(String msg, long total,int code, T data){
    ...
    public static <T> AjaxResult<T> success(String msg, Integer total){
        return success(msg,total,0,null);
    }
