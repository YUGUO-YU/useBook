...
import com.usedbook.mapper.MessageMapper;
import com.usedbook.pojo.Message;
import com.usedbook.pojo.User;
import com.usedbook.service.MessageService;
...
public class MessageController {
    ...
    @DeleteMapping("/del")
    public R del(@PathParam(value = "id") String id){

        int i =messageMapper.delete(id);
        if (i==0){
            return R.ok("失败");
        }
        return R.ok("成功");
